...
class Init_ArucoMarkers_detected
{
public:
  explicit Init_ArucoMarkers_detected(::ros2_aruco_interfaces::msg::ArucoMarkers & msg)
  : msg_(msg)
  {}
  Init_ArucoMarkers_marker_ids detected(::ros2_aruco_interfaces::msg::ArucoMarkers::_detected_type arg)
  {
...
public:
  ...
  {}
  Init_ArucoMarkers_detected header(::ros2_aruco_interfaces::msg::ArucoMarkers::_header_type arg)
  {
    msg_.header = std::move(arg);
    return Init_ArucoMarkers_detected(msg_);
  }

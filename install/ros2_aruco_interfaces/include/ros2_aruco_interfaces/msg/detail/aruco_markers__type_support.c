...
static rosidl_typesupport_introspection_c__MessageMember ArucoMarkers__rosidl_typesupport_introspection_c__ArucoMarkers_message_member_array[4] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_aruco_interfaces__msg__ArucoMarkers, detected),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2_aruco_interfaces, msg, ArucoMarkers)() {
  ...
  ArucoMarkers__rosidl_typesupport_introspection_c__ArucoMarkers_message_member_array[3].members_ =

...
: ${AMENT_CURRENT_PREFIX:="/home/jorge/capture_ws/install/alg1_pkg"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/alg1_pkg/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/alg1_pkg/environment/path.sh"
